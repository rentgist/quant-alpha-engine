...
> 데이터 기준: 최근 5영업일 / 분석 일시: 2026-09-01 14:53:20 (KST)

## 💡 세력 매집 Top 4 종목

| 순위 | 종목명 | 스나이퍼점수 | 5일등락 | 외인순매수(억) | 기관순매수(억) | 거래량폭증 | 윗꼬리(물량뺏기) |
|------|--------|-------------|---------|--------------|--------------|----------|----------------|
| 1 | 위더스제약 | **15.0** | -5.1% | +0.0 | +0.0 | 🚨포착 | 🚨포착 |
| 2 | 피스피스스튜디오 | **15.0** | +5.0% | +0.0 | +0.0 | 🚨포착 | 🚨포착 |
| 3 | 빛과전자 | **15.0** | +2.9% | +0.0 | +0.0 | 🚨포착 | 🚨포착 |
| 4 | 동양파일 | **15.0** | +4.0% | +0.0 | +0.0 | 🚨포착 | 🚨포착 |
